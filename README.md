...
<body>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='💞'>
       <p id="kalimat">Today i want to talk with u little thing 👉👈</p>

       <!-- Pesan -->
       <p id="pesan1"> Touch enough four hearts ❤️</p>
       <div id="kolombaru">
         <li id="lv1"> ❤️</li>
         <li id="lv2"> ❤️</li>
         <li id="lv3"> ❤️</li>
       ...
       <p id="pesan2"> Great 💘</p>
       <p id="pesan3">I want talk with u.....</p>
       <p id="pesan4" class="sty2">You're so cuteeee </p>
       <p id="pesan5" class="sty2">So pls don't be sad if u don't have anyone besides in Valentine day </p>
       <p id="pesan6" class="sty2">Because u will older when u sad and u deserve with the things better than it</p>

       <!-- Tombol Lanjut -->
       <p id="opsL">Okay the continue </p>
     </blockquote></div>
...
<script>
  ...
  async function inipesan(){
    var { value: nama } = await swals.fire({
           title: 'What's your name?', input: 'text',
       });
       if(nama && nama.length < 11){
         ...
         mulainama();
           ...
           await swals.fire('Your name', 'The name of the prettiest person');inipesan();
    }
  }

  
  var tanya = 'Are u free now ? 😳';
  var opstanya = 'Your choose......';
  var tompositif = 'Yes';
  var tomnegatif = 'No';
